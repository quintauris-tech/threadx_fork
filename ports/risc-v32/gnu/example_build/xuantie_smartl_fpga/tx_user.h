...
#define TX_MINIMUM_STACK                        (512 + CSK_CPU_STACK_EXTRAL)
#define TX_TIMER_THREAD_STACK_SIZE              (512 + STATIC_CSK_CPU_STACK_EXTRAL)
/*
#define TX_MAX_PRIORITIES                       32
...
#define TX_TIMER_TICKS_PER_SECOND CONFIG_SYSTICK_HZ
#else
